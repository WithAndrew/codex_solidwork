...
Public Function Build_CUS_009_ShortPressPlate(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-009"
    partName = "Short press plate 15x5x2 cm"
    fileName = "CUS-009_ShortPressPlate_150x50x20.SLDPRT"
    lengthMm = 150#
    widthMm = 50#
    heightMm = 20#
    quantity = 2#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_009_ShortPressPlate = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_009_ShortPressPlate = ""
...
Fail:
    AppendLog "Build_CUS_009_ShortPressPlate failed: " & Err.Description
