...
Public Function Build_CUS_015_SmallMountPlate(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-015"
    partName = "Small mount plate 5x5x2 cm"
    fileName = "CUS-015_SmallMountPlate_50x50x20.SLDPRT"
    lengthMm = 50#
    widthMm = 50#
    heightMm = 20#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_015_SmallMountPlate = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_015_SmallMountPlate = ""
...
Fail:
    AppendLog "Build_CUS_015_SmallMountPlate failed: " & Err.Description
