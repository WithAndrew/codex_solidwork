...
Public Function Build_CUS_026_PositionPlate(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-026"
    partName = "Position plate 7x5x2 cm"
    fileName = "CUS-026_PositionPlate_70x50x20.SLDPRT"
    lengthMm = 70#
    widthMm = 50#
    heightMm = 20#
    quantity = 4#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_026_PositionPlate = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_026_PositionPlate = ""
...
Fail:
    AppendLog "Build_CUS_026_PositionPlate failed: " & Err.Description
