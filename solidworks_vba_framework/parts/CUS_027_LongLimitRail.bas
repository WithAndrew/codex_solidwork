...
Public Function Build_CUS_027_LongLimitRail(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-027"
    partName = "Long limit rail 30x7x3 cm"
    fileName = "CUS-027_LongLimitRail_300x70x30.SLDPRT"
    lengthMm = 300#
    widthMm = 70#
    heightMm = 30#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_027_LongLimitRail = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_027_LongLimitRail = ""
...
Fail:
    AppendLog "Build_CUS_027_LongLimitRail failed: " & Err.Description
