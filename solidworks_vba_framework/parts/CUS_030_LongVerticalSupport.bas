...
Public Function Build_CUS_030_LongVerticalSupport(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-030"
    partName = "Long vertical support 25x8x2 cm"
    fileName = "CUS-030_LongVerticalSupport_250x80x20.SLDPRT"
    lengthMm = 250#
    widthMm = 80#
    heightMm = 20#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_030_LongVerticalSupport = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_030_LongVerticalSupport = ""
...
Fail:
    AppendLog "Build_CUS_030_LongVerticalSupport failed: " & Err.Description
