...
Public Function Build_CUS_028_SensorLightVerticalPlate(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-028"
    partName = "Sensor light vertical plate 31x6x2 cm"
    fileName = "CUS-028_SensorLightVerticalPlate_310x60x20.SLDPRT"
    lengthMm = 310#
    widthMm = 60#
    heightMm = 20#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_028_SensorLightVerticalPlate = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_028_SensorLightVerticalPlate = ""
...
Fail:
    AppendLog "Build_CUS_028_SensorLightVerticalPlate failed: " & Err.Description
