...
Public Function Build_CUS_024_EndCylinderPlate(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-024"
    partName = "End cylinder plate 25x7x2 cm"
    fileName = "CUS-024_EndCylinderPlate_250x70x20.SLDPRT"
    lengthMm = 250#
    widthMm = 70#
    heightMm = 20#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_024_EndCylinderPlate = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_024_EndCylinderPlate = ""
...
Fail:
    AppendLog "Build_CUS_024_EndCylinderPlate failed: " & Err.Description
