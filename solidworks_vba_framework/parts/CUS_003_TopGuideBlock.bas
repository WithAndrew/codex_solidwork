...
Public Function Build_CUS_003_TopGuideBlock(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-003"
    partName = "Top guide block 7x5x2 cm"
    fileName = "CUS-003_TopGuideBlock_70x50x20.SLDPRT"
    lengthMm = 70#
    widthMm = 50#
    heightMm = 20#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_003_TopGuideBlock = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_003_TopGuideBlock = ""
...
Fail:
    AppendLog "Build_CUS_003_TopGuideBlock failed: " & Err.Description
