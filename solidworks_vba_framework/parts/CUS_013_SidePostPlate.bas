...
Public Function Build_CUS_013_SidePostPlate(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-013"
    partName = "Side post plate 6x5x2 cm"
    fileName = "CUS-013_SidePostPlate_60x50x20.SLDPRT"
    lengthMm = 60#
    widthMm = 50#
    heightMm = 20#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_013_SidePostPlate = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_013_SidePostPlate = ""
...
Fail:
    AppendLog "Build_CUS_013_SidePostPlate failed: " & Err.Description
