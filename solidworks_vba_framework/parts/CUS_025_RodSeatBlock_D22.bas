...
Public Function Build_CUS_025_RodSeatBlock_D22(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-025"
    partName = "Rod seat block for 22 diameter rod mark"
    fileName = "CUS-025_RodSeatBlock_D22.SLDPRT"
    lengthMm = 90#
    widthMm = 70#
    heightMm = 60#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_025_RodSeatBlock_D22 = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_025_RodSeatBlock_D22 = ""
...
Fail:
    AppendLog "Build_CUS_025_RodSeatBlock_D22 failed: " & Err.Description
