...
Public Function Build_PUR_002_RightBowl(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "PUR-002"
    partName = "Right bowl feeder simplified envelope"
    fileName = "PUR-002_RightBowl.SLDPRT"
    lengthMm = 480#
    widthMm = 480#
    heightMm = 280#
    quantity = 1#
    ...
    CreateCylinder model, lengthMm, heightMm
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_PUR_002_RightBowl = filePath
        AppendLog fileName & " saved"
    Else
        Build_PUR_002_RightBowl = ""
...
Fail:
    AppendLog "Build_PUR_002_RightBowl failed: " & Err.Description
