...
Public Function Build_CUS_014_VerticalNarrowPlate(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-014"
    partName = "Vertical narrow plate 10x4x1 cm"
    fileName = "CUS-014_VerticalNarrowPlate_100x40x10.SLDPRT"
    lengthMm = 100#
    widthMm = 40#
    heightMm = 10#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_014_VerticalNarrowPlate = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_014_VerticalNarrowPlate = ""
...
Fail:
    AppendLog "Build_CUS_014_VerticalNarrowPlate failed: " & Err.Description
