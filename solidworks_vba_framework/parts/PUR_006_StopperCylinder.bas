...
Public Function Build_PUR_006_StopperCylinder(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "PUR-006"
    partName = "Stopper indexing cylinder envelope"
    fileName = "PUR-006_StopperCylinder.SLDPRT"
    lengthMm = 160#
    widthMm = 45#
    heightMm = 45#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_PUR_006_StopperCylinder = filePath
        AppendLog fileName & " saved"
    Else
        Build_PUR_006_StopperCylinder = ""
...
Fail:
    AppendLog "Build_PUR_006_StopperCylinder failed: " & Err.Description
