...
Public Function Build_CUS_012_CylinderMountPlate(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-012"
    partName = "Cylinder mount plate 28x7x2 cm"
    fileName = "CUS-012_CylinderMountPlate_280x70x20.SLDPRT"
    lengthMm = 280#
    widthMm = 70#
    heightMm = 20#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_012_CylinderMountPlate = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_012_CylinderMountPlate = ""
...
Fail:
    AppendLog "Build_CUS_012_CylinderMountPlate failed: " & Err.Description
