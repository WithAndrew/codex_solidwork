...
Public Function Build_CUS_005_VerticalStopPlate(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-005"
    partName = "Vertical stop plate 14x7x2 cm"
    fileName = "CUS-005_VerticalStopPlate_140x70x20.SLDPRT"
    lengthMm = 140#
    widthMm = 70#
    heightMm = 20#
    quantity = 2#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_005_VerticalStopPlate = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_005_VerticalStopPlate = ""
...
Fail:
    AppendLog "Build_CUS_005_VerticalStopPlate failed: " & Err.Description
