...
Public Function Build_CUS_017_PusherTallBlock(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-017"
    partName = "Pusher tall block 21x7x2 cm"
    fileName = "CUS-017_PusherTallBlock_210x70x20.SLDPRT"
    lengthMm = 210#
    widthMm = 70#
    heightMm = 20#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_017_PusherTallBlock = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_017_PusherTallBlock = ""
...
Fail:
    AppendLog "Build_CUS_017_PusherTallBlock failed: " & Err.Description
