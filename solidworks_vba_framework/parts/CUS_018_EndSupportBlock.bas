...
Public Function Build_CUS_018_EndSupportBlock(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-018"
    partName = "End support block 6x6x5 cm"
    fileName = "CUS-018_EndSupportBlock_60x60x50.SLDPRT"
    lengthMm = 60#
    widthMm = 60#
    heightMm = 50#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_018_EndSupportBlock = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_018_EndSupportBlock = ""
...
Fail:
    AppendLog "Build_CUS_018_EndSupportBlock failed: " & Err.Description
