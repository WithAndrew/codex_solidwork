...
Public Function Build_CUS_034_LinearFeederInsertPlate(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-034"
    partName = "Linear feeder insertion plate, 5 cm insertion allowance"
    fileName = "CUS-034_LinearFeederInsertPlate_500x70x20.SLDPRT"
    lengthMm = 500#
    widthMm = 70#
    heightMm = 20#
    quantity = 2#
    materialName = "TO_BE_CONFIRMED"
    photoReference = "41,42,44"
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_034_LinearFeederInsertPlate = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_034_LinearFeederInsertPlate = ""
...
Fail:
    AppendLog "Build_CUS_034_LinearFeederInsertPlate failed: " & Err.Description
