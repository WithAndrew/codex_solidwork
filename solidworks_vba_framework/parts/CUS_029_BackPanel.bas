...
Public Function Build_CUS_029_BackPanel(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-029"
    partName = "Back panel estimated from 108x3 cm mark"
    fileName = "CUS-029_BackPanel_1080x30x20.SLDPRT"
    lengthMm = 1080#
    widthMm = 30#
    heightMm = 20#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_029_BackPanel = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_029_BackPanel = ""
...
Fail:
    AppendLog "Build_CUS_029_BackPanel failed: " & Err.Description
