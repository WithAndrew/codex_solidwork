...
Public Function Build_CUS_010_TallSidePlate(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-010"
    partName = "Tall side plate 30x7x2 cm"
    fileName = "CUS-010_TallSidePlate_300x70x20.SLDPRT"
    lengthMm = 300#
    widthMm = 70#
    heightMm = 20#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_010_TallSidePlate = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_010_TallSidePlate = ""
...
Fail:
    AppendLog "Build_CUS_010_TallSidePlate failed: " & Err.Description
