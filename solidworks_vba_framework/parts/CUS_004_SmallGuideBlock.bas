...
Public Function Build_CUS_004_SmallGuideBlock(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-004"
    partName = "Small guide block 5x4x2 cm"
    fileName = "CUS-004_SmallGuideBlock_50x40x20.SLDPRT"
    lengthMm = 50#
    widthMm = 40#
    heightMm = 20#
    quantity = 2#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_004_SmallGuideBlock = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_004_SmallGuideBlock = ""
...
Fail:
    AppendLog "Build_CUS_004_SmallGuideBlock failed: " & Err.Description
