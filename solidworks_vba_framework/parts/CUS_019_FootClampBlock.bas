...
Public Function Build_CUS_019_FootClampBlock(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-019"
    partName = "Foot clamp block 7x7x2 cm"
    fileName = "CUS-019_FootClampBlock_70x70x20.SLDPRT"
    lengthMm = 70#
    widthMm = 70#
    heightMm = 20#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_019_FootClampBlock = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_019_FootClampBlock = ""
...
Fail:
    AppendLog "Build_CUS_019_FootClampBlock failed: " & Err.Description
