...
Public Function Build_CUS_032_TubeClamp(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "CUS-032"
    partName = "Tube clamp 7x6x2 cm"
    fileName = "CUS-032_TubeClamp_70x60x20.SLDPRT"
    lengthMm = 70#
    widthMm = 60#
    heightMm = 20#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_CUS_032_TubeClamp = filePath
        AppendLog fileName & " saved"
    Else
        Build_CUS_032_TubeClamp = ""
...
Fail:
    AppendLog "Build_CUS_032_TubeClamp failed: " & Err.Description
