...
Public Function Build_PUR_004_RightLinearFeeder(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "PUR-004"
    partName = "Right linear feeder body"
    fileName = "PUR-004_RightLinearFeeder.SLDPRT"
    lengthMm = 520#
    widthMm = 80#
    heightMm = 55#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_PUR_004_RightLinearFeeder = filePath
        AppendLog fileName & " saved"
    Else
        Build_PUR_004_RightLinearFeeder = ""
...
Fail:
    AppendLog "Build_PUR_004_RightLinearFeeder failed: " & Err.Description
