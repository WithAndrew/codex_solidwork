...
Public Function Build_PUR_003_LeftLinearFeeder(ByVal swApp As Object, ByVal outputDir As String) As String
    On Error GoTo Fail
    ...
    partNo = "PUR-003"
    partName = "Left linear feeder body"
    fileName = "PUR-003_LeftLinearFeeder.SLDPRT"
    lengthMm = 520#
    widthMm = 80#
    heightMm = 55#
    quantity = 1#
    ...
    If SaveModel(swApp, model, filePath) Then
        Build_PUR_003_LeftLinearFeeder = filePath
        AppendLog fileName & " saved"
    Else
        Build_PUR_003_LeftLinearFeeder = ""
...
Fail:
    AppendLog "Build_PUR_003_LeftLinearFeeder failed: " & Err.Description
